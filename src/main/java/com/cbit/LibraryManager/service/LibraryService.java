...
public class LibraryService {
	...
	public String addBookService(Book book) throws Exception {
		...
		String result = "";
		if (row == 1) {
			result = "Book " + book.getbName() + " was Stored in the rack named '"+book.getbCategory() +"' successfully!!";
		} else {
...
public String searchBookService( SearchBook searchBook) throws Exception {
		...
		String searchBookRepo = repository.searchBookRepo(searchBook) ;
		
	return searchBookRepo;
